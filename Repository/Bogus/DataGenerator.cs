    ...
    public static class DataGenerator
    {
        ...
        private static Faker<Apartment> GetApartmentGenerator(Guid ownerId) =>
            new Faker<Apartment>()
                ...
                .RuleFor(a => a.Name, f => f.Lorem.Random.String(10))
                .RuleFor(a => a.Address, f => f.Address.FullAddress())
                .RuleFor(a => a.CapacitySquare, f => f.Random.Double()*100)
                ...
                .RuleFor(a => a.Rate, f => f.Random.Double())
                .RuleFor(a => a.ReviewsCount, f => f.Random.Int(0))
